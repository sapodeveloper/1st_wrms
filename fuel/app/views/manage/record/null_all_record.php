...
<ul class="nav nav-tabs">
	<li><?php echo Html::anchor('index/manage/record/', '全レコード一覧'); ?></li>
	<li class="active"><?php echo Html::anchor('index/manage/record/NullAllRecord', '空レコード一覧'); ?></li>
	<li><?php echo Html::anchor('index/manage/record/GroupNullRecord', 'レコードなしグループ'); ?></li>
